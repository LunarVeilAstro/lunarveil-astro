...
function TEMPLE_SLIPS_GUANYIN() {
  if (typeof TEMPLE_SLIPS_GUANYIN_ZH === "undefined") return [];
  return (window._lang && window._lang() === "en") ? TEMPLE_SLIPS_GUANYIN_EN : TEMPLE_SLIPS_GUANYIN_ZH;
}
function TEMPLE_SLIPS_GUANDI() {
  if (typeof TEMPLE_SLIPS_GUANDI_ZH === "undefined") return [];
  return (window._lang && window._lang() === "en") ? TEMPLE_SLIPS_GUANDI_EN : TEMPLE_SLIPS_GUANDI_ZH;
}
function TEMPLE_SLIPS_LVZU() {
  if (typeof TEMPLE_SLIPS_LVZU_ZH === "undefined") return [];
  return (window._lang && window._lang() === "en") ? TEMPLE_SLIPS_LVZU_EN : TEMPLE_SLIPS_LVZU_ZH;
}
