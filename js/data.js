...
const TEMPLE_SLIPS_GUANYIN_ZH = [
  {id:1,level:'上签',title:'钟离成道',poem:'开天辟地作良缘\n吉日良时万物全\n若得此签非小可\n人行忠正帝王宣',vernacular:'天地开辟之初就定下了良缘，在吉日良时万物都得以成全。抽到这支签非同小可——只要做人忠正，连帝王都会为你宣扬。这是观音灵签第一签"开元之签"，万象更新的吉兆。',interpretation:{career:'开创性的机遇来临，正直做人自有贵人赏识',love:'天赐良缘，是正经可靠的缘分',wealth:'正财亨通，诚信经营必有回报',health:'身心焕然一新',study:'名列前茅，成绩斐然',family:'家运初开，一切向好',overall:'钟离权原是汉朝将军，后来辞官修道成为八仙之首。此签讲人生有比功名更高的追求——但你先要把人间的事做好，忠正二字是根基'},dos:'宜：开业、求职、求婚、远行、签约',donts:'忌：犹豫不决、错失良机',luckyColor:'朝阳金',luckyNum:'1 / 6',luckyDir:'正东'},
  {id:16,level:'中签',title:'叶梦熊朝帝',poem:'愁眉思虑暂时开\n启出云霄喜自来\n宛如粪土中藏玉\n良工荐举出尘埃',vernacular:'愁眉不展的思虑暂时放开了，拨开云霄喜气自然来到。就像粪土之中藏着美玉，好的工匠会把它荐举出来脱离尘埃。此签讲"是金子总会发光"——叶梦熊朝见皇帝请求领兵，虽是布衣却有将帅之才。',interpretation:{career:'你的价值即将被识货的人发现',love:'别人眼里的"普通人"可能是你的珍宝',wealth:'被人忽视的资产或项目可能很有价值',health:'找到真正专业的医生',study:'被老师发掘和推荐',family:'你一直不被家人看重的优点将被认可',overall:'你就像藏在粪土里的玉，不是你不值钱，是还没遇到识货的人。此签说那个能认出你的人，已经在路上了'},dos:'宜：展示实力、等待伯乐、不要自我贬低',donts:'忌：因暂时不被认可而自暴自弃',luckyColor:'美玉青',luckyNum:'6 / 1',luckyDir:'正东'},
  {id:55,level:'中签',title:'周武王登位',poem:'父贤传子子传孙\n衣食丰隆只靠天\n堂上椿萱人快乐\n饥饭渴饮因时眠',vernacular:'父亲贤德传给儿子、儿子传给孙子，衣食丰隆只需要靠天。堂上的父母快乐健康，饿了吃饭渴了喝水困了就睡觉。此签讲"自然传承，顺天应时"——周武王继承文王的遗志伐纣兴周，一切按部就班自然成就。',interpretation:{career:'守成和继承同样重要，不需要另起炉灶',love:'家风好的伴侣是结婚的好对象',wealth:'继承的资产稳定增值',health:'保持良好的生活习惯就是最好的养生',study:'承前启后，在已有基础上深耕',family:'传承和延续是家的意义',overall:'周武王完成的是他父亲文王未竟的事业。此签说你不用从头再来——你父辈打下的基础很好，把接力棒接过来跑下去就行'},dos:'宜：传承、守成、按部就班',donts:'忌：推翻重来、不尊重前人的积累',luckyColor:'传承赤',luckyNum:'5 / 0',luckyDir:'正中'},
];
...
const TEMPLE_SLIPS_GUANDI_ZH = [
  {id:1,level:'大吉签',title:'汉高祖入关',poem:'巍巍独步向云间\n玉殿千官第一班\n富贵荣华天付汝\n福如东海寿如山',vernacular:'你正走在一条无人可及的上升之路上。巍巍高山独步攀登，玉殿之上位列第一班。富贵荣华是上天注定给你的，福气如东海之深、寿命如南山之高。这是百签之中最上等的吉兆。',interpretation:{career:'位极人臣，独占鳌头，升迁在即',love:'良缘天定，佳偶自成',wealth:'富贵逼人，财源广进',health:'福寿绵长，身体康泰',study:'名列第一，金榜题名',family:'家运昌隆，福泽深厚',overall:'此签为关帝灵签第一签"开门红"，万事亨通。但需谨记高位者更要谦逊，位高权重时当思福祸相倚'},dos:'宜：求职、跳槽、求婚、开业、签约、远行',donts:'忌：骄傲自满、目中无人',luckyColor:'琥珀金',luckyNum:'1 / 6',luckyDir:'正南'},
  {id:51,level:'上吉签',title:'御沟流红叶',poem:'君今百事且随缘\n水到渠成听自然\n莫叹年来不如意\n喜逢新运称心田',vernacular:'你如今百事暂且随缘吧，水到渠成一切听其自然。不要感叹近年不如意，很快会喜逢新运称心如意。此签讲"随缘，好运自来"——御沟流红叶是良缘天降的典故。',interpretation:{career:'不必强求，机会会自己找上门',love:'缘分妙不可言，对的人会出现在对的时间',wealth:'顺其自然反有意外之财',health:'放松心态最利健康',study:'自然状态下的学习效率最高',family:'随缘随分，家庭自然和睦',overall:'御沟流红叶，宫女题诗被书生捡到，最终成婚。此签说你只管做好自己，缘分和好运都在来的路上'},dos:'宜：随缘、放松、做好当下的事',donts:'忌：强求、焦虑、过度努力',luckyColor:'枫叶红',luckyNum:'1 / 6',luckyDir:'正中'},
  {id:100,level:'上上签',title:'唐明宗祷告天',poem:'我本天仙雷雨师\n吉凶祸福我先知\n至诚祷告皆灵验\n抽得终签百事宜',vernacular:'我本来就是天上的雷雨之师，吉凶祸福我都能预知。只要至诚祷告全都灵验，抽到这最后一签，百事都合宜。此签为关帝灵签第一百签——终签，百签之末，集大成之吉。',interpretation:{career:'你所求之事皆可成就',love:'真心祷告，缘分自来',wealth:'至诚之心引来财富',health:'神灵护佑，身心安康',study:'所有努力皆有回报',family:'阖家安康，百事顺遂',overall:'赵阅道每晚焚香告天，把自己一天做的事如实禀报。此签说"诚心通天"——你是第一百签抽到的，这是"终签百事宜"的终极祝福。但也要学习赵阅道：每天如实面对自己，至诚则灵'},dos:'宜：发愿、还愿、感恩、开启新篇章',donts:'忌：不诚不信、抽到终签后懈怠',luckyColor:'天仙金',luckyNum:'0 / 1',luckyDir:'正中'},
];
...
const TEMPLE_SLIPS_LVZU_ZH = [
  {id:1,level:'上上签',title:'王母祝寿',poem:'蓬莱东阁玉桃香\n顺水行舟仙赐方\n宜男正好图全计\n不必他方卜地长\n\n诗曰：\n占得鳌头百事成\n逢迎到处不须疑\n从兹修省能方便\n福禄绵绵自可期',vernacular:'蓬莱仙阁的玉桃已经飘香，顺着水流行舟自有仙人赐予良方。正是谋划全局的好时机，不必再去别的地方占卜寻找了。王母祝寿众仙来贺——你正处在被祝福的运势中，但不可因好运而懈怠。"诗曰"补充说：占了鳌头百事可成，所到之处不必疑虑。从现在起修行自省最能顺遂，福禄绵长自然可期。',interpretation:{career:'独占鳌头之兆，但成功后更要修省自持',love:'天赐良缘，不必东张西望',wealth:'正财顺遂，此时规划全局最佳',health:'仙桃赐福，身心俱泰',study:'百事可成，名列前茅',family:'阖家吉庆，福泽绵长',overall:'此为吕祖灵签第一签——王母祝寿，众仙来贺。好运来了，但"修省能方便"四个字是关键'},dos:'宜：开业、求职、求婚、制定长期计划',donts:'忌：骄傲怠惰、不修自身',luckyColor:'蓬莱金',luckyNum:'1 / 6',luckyDir:'正中'},
  {id:50,level:'中平签',title:'崔莺莺小姐',poem:'一声莺报上林春\n恐是虚声\n未必峥嵘\n若要峥嵘\n还候丙丁',vernacular:'一声黄莺报晓说上林苑已经是春天了——但这恐怕是虚的，未必是真的峥嵘。要想峥嵘，还得等到丙丁（火旺之时）。此签讲"好消息不能尽信，真的盛世还要等丙丁"——崔莺莺和张生的爱情一波三折。',interpretation:{career:'好消息要打折听——真正的突破还要等到丙丁日或夏季',love:'第一印象很美好但要深入了解',wealth:'表面的繁荣不一定真实',health:'初步的好转不要过于乐观',study:'小进步可喜但大突破要再等',family:'家中的好消息要核实一下',overall:'黄莺的声音很美——但它报的春有时候是假的。此签说那只黄莺叫得很好听，但你要等丙丁——那才是真的春天'},dos:'宜：核实消息、等待丙丁、不要天真',donts:'忌：听了就信、不核实、太天真',luckyColor:'莺声黄',luckyNum:'0 / 5',luckyDir:'正南'},
  {id:99,level:'中平签',title:'邓艾钟会入川',poem:'可以转移，可以了结\n只恨运命迍邅\n故此一得一失',vernacular:'可以转移方向，也可以了结收场。只恨运势命运多舛困顿——所以才一得一失。邓艾和钟会入川灭蜀，立下大功却双双被杀——功成而身不退的悲剧。',interpretation:{career:'进退都可以，但命运多舛，得失参半',love:'可以转移也可以了结，你自己决定',wealth:'一得一失是常态，接受就好',health:'运命迍邅时身体也反复，有得有失',study:'有科目好有科目差，接受不完美',family:'得失之间保持平常心就是幸福',overall:'邓艾钟会入川灭了蜀国，自己也没了。此签说"可以转移可以了结"——进退皆有道理，但命运多舛，一得一失是常态'},dos:'宜：灵活选择、接受得失、知进退',donts:'忌：贪得无厌、不知进退、不接受损失',luckyColor:'蜀道青',luckyNum:'9 / 3',luckyDir:'西南'},
];
