...
(function() {
  ...
  add('about.p3', '我在自己的星盘里看到了我为什么习惯把情绪咽下去、我为什么坚持得比别人久、我为什么缺的那口气恰好推着我每天跟世界说话。我第一次觉得——原来我不是"有问题"，我是有一份出厂说明书，而我从来没拿到过。', 'In my own birth chart, I saw why I swallow my emotions instead of speaking them, why I persist long after others give up, why the element I lack is the very thing pushing me to show up and talk to the world every day. For the first time, I understood — I wasn\'t broken. I just never got my owner\'s manual.');
  ...
  add('about.p6', '星盘不是答案，不是命运，不是判决书。它是你出生那一刻的行星位置——你的出厂说明书。告诉你你生来带的是什么配置、哪些是你出厂就有的武器、哪些只是你还没学会开的开关。', 'A birth chart is not an answer, not a fate, not a verdict. It\'s the position of the planets at the exact moment you were born — your owner\'s manual. It tells you what configuration you came with, which weapons were already in the box, and which switches you just haven\'t learned to flip yet.');
